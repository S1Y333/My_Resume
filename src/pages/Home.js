...
const Home = () => {
  ...
  const style = { marginTop: 100 };  
    ...
    <img class="d-block mx-auto mb-4" src="https://res.cloudinary.com/dsaaaqnqj/image/upload/v1703034052/e277a8e6dfab58e9321cdd4510ef4c04_a83nrm.png" alt="" width="150" height="100"  style={style}/>
...
<div class="box" >
  ...
  <div class="content">
    <div>
      ...
      <p>ReactJS, NodeJS, ExpressJS, MongoDB
      </p>
    </div>
  </div>
  </Link>
...
<div class="box">
  <div class="imgBx">
    <img src="https://images.unsplash.com/photo-1485217988980-11786ced9454?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
  </div>
  <Link to={"/projects/project-3"}>
  <div class="content">
    <div>
      <h2>ECOMMERCE APP</h2>
      <p>Angular, Java Spring Boot, MySQL
      </p>
    </div>
  </div>
  </Link>
