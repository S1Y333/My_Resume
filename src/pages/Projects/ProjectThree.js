...
const ProjectThree = () => {
  ...
  return <div className="">
      ...
      <span class="heading-sec__main" style={style}>ANGULAR & JAVA ECOMMERCE APP</span>
      <span class="heading-sec__sub">
      This page contains the case study of ANGULAR & JAVA ECOMMERCE APP which includes the Project Overview, Tools Used for the official product.
      </span><br />
