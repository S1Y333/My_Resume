...
const ProjectOne = () => {
  ...
  return <div className="">
      ...
      <span class="heading-sec__main" style={style}>Place Sharing App</span>
      <span class="heading-sec__sub">
      This page contains the case study of Place Sharing App which includes the Project Overview, Tools Used and Live Links to the official product.
      </span><br />
        ...
        <div class="project-details__content-main">
          <div class="project-details__desc">
            ...
            <p class="project-details__desc-para">
              Place sharing web app that registered users can share their favourite places for other users to browse.
              
            </p>
            <p class="project-details__desc-para">
              The places will have Google Map and Open Weather API supported data for user's reference.
            </p>
            <p class="project-details__desc-para">
